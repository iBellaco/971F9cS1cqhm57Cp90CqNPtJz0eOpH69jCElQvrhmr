...
# Replace from 'fun generateTacticalAdvice' to the end of the file
content = re.sub(r'fun generateTacticalAdvice\([\s\S]*$', '''fun generateTacticalAdvice(champion: Champion, activeRole: LaneRole, lang: String): String {
