cat << 'PATCH' > dialog.patch
--- app/src/main/java/com/example/ui/components/AvatarSelectionDialog.kt
+++ app/src/main/java/com/example/ui/components/AvatarSelectionDialog.kt
@@ -58,6 +58,7 @@
...
+                                            borderId = border,
+                                            onSuccess = {
+                                                Toast.makeText(context, "Marco actualizado", Toast.LENGTH_SHORT).show()
+                                            },
+                                            onError = { err ->
...
+                                            size = 64.dp,
+                                            rankBorder = border,
+                                            showBorder = false // don't show inner rarity border when testing rank borders
+                                        )
+                                        if (!isAvailable) {
+                                            Box(
+                                                modifier = Modifier
...
PATCH
patch app/src/main/java/com/example/ui/components/AvatarSelectionDialog.kt < dialog.patch
