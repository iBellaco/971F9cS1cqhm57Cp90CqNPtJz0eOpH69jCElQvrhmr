...
val translations = mapOf(
    "pt" to mapOf(
        "Línea:" to "Rota:",
        "1er Pick" to "1º Pick",
        "1er Pick (Seguro)" to "1º Pick (Seguro)",
        "Inicio" to "Início",
        ...
        "Prioridad de Habilidades (Skill Order)" to "Prioridade de Habilidades (Ordem de Evolução)",
        "Maxeo:" to "Maximizar:",
        "Hechizos" to "Feitiços",
        "Runas" to "Runas",
        "Destello (Flash)" to "Flash",
        "Prender (Ignite)" to "Incendiar (Ignite)",
        "Extenuación" to "Exaustão",
        "Barrera" to "Barreira",
        "Curar (Heal)" to "Curar (Heal)",
        "Fantasma (Ghost)" to "Fantasma (Ghost)",
        "Estasis (Zhonya)" to "Estase (Zhonya)",
...
,
        ...
        "Core Items (Obligatorios):" to "Itens Principais (Obrigatórios):",
        "Objetos Situacionales:" to "Itens Situacionais:",
    ...
    "en" to mapOf(
        ...
        "1er Pick (Seguro)" to "1st Pick (Safe)",
        "Inicio" to "Home",
        "Catálogo" to "Catalog",
        "Top" to "Top",
        "Mid" to "Mid",
        ...
        "Prioridad de Habilidades (Skill Order)" to "Skill Priority (Skill Order)",
        "Maxeo:" to "Max:",
        "Hechizos" to "Spells",
        "Runas" to "Runes",
        "Destello (Flash)" to "Flash",
        "Prender (Ignite)" to "Ignite",
        "Extenuación" to "Exhaust",
        "Barrera" to "Barrier",
        "Curar (Heal)" to "Heal",
        "Fantasma (Ghost)" to "Ghost",
        "Estasis (Zhonya)" to "Stasis (Zhonya)",
        "Definitiva" to "Ultimate",
        "CD Tracker:" to "CD Tracker:",
        "Rival" to "Enemy",
...
,
        ...
        "Core Items (Obligatorios):" to "Core Items (Mandatory):",
        "Objetos Situacionales:" to "Situational Items:",
