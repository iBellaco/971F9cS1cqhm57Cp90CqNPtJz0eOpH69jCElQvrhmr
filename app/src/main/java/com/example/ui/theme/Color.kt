...
// Hextech & Wild Rift Premium Theme Colors
val HextechDarkBg = Color(0xFF070C18)
val HextechSurface = Color(0xFF0D172A)
val HextechSurfaceVariant = Color(0xFF13223E)
val HextechCardBorder = Color(0xFF1E355B)
