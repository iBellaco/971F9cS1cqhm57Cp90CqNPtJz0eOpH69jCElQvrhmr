...
object WildRiftItemsData {
    val list: List<WildRiftItem> = listOf(
        ...
        WildRiftItem(
            ...
            goldCost = 0,
            stats = "+175 de salud máxima • +10 de celeridad de habilidad",
            statsEn = "+175 Max Health • +10 Ability Haste",
            passive = "Soulcast: Cada 6",
        ...
        WildRiftItem(
            ...
            category = "Artículos de Apoyo",
            goldCost = 0,
            stats = "+10 celeridad de habilidad",
            statsEn = "+10 Ability Haste",
            passive = "Versátil: obtiene 14 de daño de ataque o 28 de poder de habilidad (adaptable).\nSoulcast: Cada 6",
        ...
        WildRiftItem(
            ...
            stats = "",
            statsEn = "",
            passive = "Quicksilver (activo): elimina todos los efectos de control de masas que te afectan actualmente y te vuelve inmune a los efectos de control de masas durante 0,25 segundos.\nPerseverancia (Pasivo): Cuando terminan los efectos de Quicksilver, otorga 30% de tenacidad y 30% de resistencia lenta durante 1,5 segundos. (60 s de enfriamiento) No se puede usar durante los efectos de derribar o derribar.",
            ...
            coachTip = "Este encantamiento elimina instantáneamente la mayoría de los efectos de control de masas y otorga brevemente inmunidad a más incapacitaciones. Una vez que finaliza el efecto, proporciona una mayor resistencia al control de multitudes y ralentiza, lo que te ayuda a escapar de situaciones peligrosas o continuar luchando sin interrupciones. Es una excelente opción contra equipos con un gran control de multitudes, lo que te permite mantenerte móvil y efectivo en momentos cruciales.",
        ...
        WildRiftItem(
            ...
            name = "Guardabrazos del buscador de Wild Rift de LoL",
            nameEn = "LoL Wild Rift Seeker's Armguard",
            category = "Objetos de Hechizo Activos",
            goldCost = 1200,
            stats = "+20 Armadura • +35 Poder de Habilidad",
            statsEn = "+20 Armor • +35 Ability Power",
            passive = "Estasis (activa): te vuelves invulnerable e inalcanzable durante 2,5 segundos, pero no puedes moverte, atacar, lanzar habilidades ni usar objetos. (120s de tiempo de reutilización)",
            ...
            coachTip = "Este objeto combina poder de habilidad con defensa adicional, pero su característica definitoria es la capacidad de volverse temporalmente invulnerable. Su efecto activo te permite evitar por completo daños letales, esquivar habilidades enemigas cruciales o ganar tiempo para que regresen tus tiempos de reutilización. Es una excelente opción para magos y asesinos AP que necesitan sobrevivir al daño explosivo y superar a sus oponentes en peleas de equipo críticas.",
        ...
        WildRiftItem(
            ...
            category = "Botas Nivel 2",
            goldCost = 1200,
            stats = "+35% de velocidad de ataque • +45 de velocidad de movimiento",
            statsEn = "+35% Attack Speed • +45 Move Speed",
            passive = "Blessed Blade: los ataques restauran 10 de salud al golpear.",
        ...
        WildRiftItem(
            id = "mercury_s_treads",
            name = "Las huellas de Mercurio",
            nameEn = "Mercury's Treads",
            category = "Botas Nivel 2",
            goldCost = 1200,
            stats = "+150 Salud máxima • +25 Resistencia mágica • +30 Tenacidad • +45 Velocidad de movimiento",
        ...
        WildRiftItem(
            id = "plated_steelcaps",
            name = "Tapas de acero plateadas",
            nameEn = "Plated Steelcaps",
            category = "Botas Nivel 2",
            goldCost = 1200,
            stats = "+150 salud máxima • +20 armadura • +45 velocidad de movimiento",
            statsEn = "+150 Max Health • +20 Armor • +45 Move Speed",
            passive = "Bloquear: Reduce el daño de los ataques de campeones en un 10%.",
        ...
        WildRiftItem(
            ...
            name = "Botas jónicas de la lucidez",
            nameEn = "Ionian Boots of Lucidity",
            category = "Botas Nivel 2",
            goldCost = 1000,
            stats = "+50 % de regeneración de maná • +15 de celeridad de habilidad • +45 de velocidad de movimiento",
            statsEn = "+50% Mana Regen • +15 Ability Haste • +45 Move Speed",
            passive = "Invocado: Reduce los tiempos de reutilización de los hechizos en un 15%.",
        ...
        WildRiftItem(
            ...
            passive = "Equilibrio: los campeones sin maná obtienen un 50 % de regeneración de vida adicional.\nBig Bully: Los ataques y las habilidades activas infligen 18 de daño verdadero adicional a los súbditos.",
        ...
        WildRiftItem(
            ...
            category = "Botas Nivel 3",
            goldCost = 2200,
            stats = "+50 % de velocidad de ataque • +5 % de vampiro físico • +45 de velocidad de movimiento",
            statsEn = "+50% Attack Speed • +5% Physical Vamp • +45 Move Speed",
            passive = "Marcha noxiana: los ataques contra campeones enemigos otorgan velocidad de movimiento (10% para campeones cuerpo a cuerpo / 7% para campeones a distancia) que disminuye en 2 segundos.\nBlessed Blade: los ataques restauran 12 de salud al golpear.",
        ...
        WildRiftItem(
            ...
            name = "Trituradoras con cadenas",
            nameEn = "Chainlaced Crushers",
            category = "Botas Nivel 3",
            goldCost = 2200,
            stats = "+150 salud máxima • +30 resistencia mágica • +30% tenacidad • +45 velocidad de movimiento",
            statsEn = "+150 Max Health • +30 Magic Resistance • +30% Tenacity • +45 Move Speed",
            passive = "Persistencia noxiana: después de recibir daño mágico de un campeón, obtienes un escudo mágico que absorbe entre 10 y 120 más un 5 % como máximo durante 5 s. (12 s de tiempo de reutilización)",
        ...
        WildRiftItem(
            ...
            category = "Botas Nivel 3",
            goldCost = 2200,
            stats = "+150 salud máxima • +30 armadura • +45 velocidad de movimiento",
            statsEn = "+150 Max Health • +30 Armor • +45 Move Speed",
            passive = "Bloquear: Reduce el daño de los ataques de campeones en un 10%.\nResistencia noxiana: después de recibir daño físico de un campeón, otorga un escudo físico que absorbe daño equivalente a 10-140 más un 8% de salud máxima. (12 s de tiempo de reutilización)",
        ...
        WildRiftItem(
            ...
            category = "Botas Nivel 3",
            goldCost = 2000,
            stats = "+75% de regeneración de maná • +25 celeridad de habilidad • +45 velocidad de movimiento",
            statsEn = "+75% Mana Regeneration • +25 Ability Haste • +45 Move Speed",
            passive = "Invocado: Reduce el tiempo de reutilización del hechizo en un 20%.\nCeleridad noxiana: curar o proteger a campeones aliados, lanzar un hechizo o infligir daño a enemigos con habilidades otorga velocidad de movimiento (10% para campeones cuerpo a cuerpo / 8% para campeones a distancia) durante 4 segundos. Este efecto solo se puede activar una vez cada 4 segundos por habilidad.",
        ...
        WildRiftItem(
            ...
            name = "Zapatos del lanzador de hechizos",
            ...
            passive = "Equilibrio: los campeones sin maná obtienen un 50 % de regeneración de salud básica.\nBig Bully: Los ataques y las habilidades activas infligen 18 de daño verdadero adicional a los súbditos.",
        ...
        WildRiftItem(
            ...
            passive = "Cloudwalker: Gana 20 de velocidad de movimiento fuera de combate.",
        ...
        WildRiftItem(
            ...
            name = "Puño de Jaurim Wild Rift",
            nameEn = "Jaurim's Fist Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1100,
            stats = "+175 de salud máxima • +15 de daño de ataque",
        ...
        WildRiftItem(
            id = "sheen_wild_rift",
            name = "Grieta salvaje brillante",
            nameEn = "Sheen Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 800,
            stats = "+10 celeridad de habilidad",
            statsEn = "+10 Ability Haste",
            passive = "Espada mágica: el uso de una habilidad hace que el siguiente ataque usado dentro de 10 segundos inflija daño físico adicional equivalente al 100 % del daño del ataque base. (Reutilización de 1,5 s) El daño se reduce frente a las estructuras.",
        ...
        WildRiftItem(
            ...
            name = "Grieta salvaje de ceniza de Bami",
            nameEn = "Bami's Cinder Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1300,
            stats = "+250 salud máxima",
            statsEn = "+250 Max Health",
            passive = "Cinders: Inflige de 10 a 20 de daño mágico por segundo a los enemigos cercanos. Inflige un 15% de daño adicional a súbditos y monstruos.",
        ...
        WildRiftItem(
            ...
            name = "Capucha de espectro Wild Rift",
            nameEn = "Spectre's Cowl Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1100,
            stats = "+175 de salud máxima • +20 de resistencia mágica",
            statsEn = "+175 Max Health • +20 Magic Resistance",
            passive = "Visita espectral: Otorga 150% de regeneración de salud durante 10 segundos después de recibir daño de un campeón enemigo.",
        ...
        WildRiftItem(
            ...
            name = "Cinturón de gigante Wild Rift",
            nameEn = "Giant's Belt Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1000,
            stats = "+300 salud máxima",
        ...
        WildRiftItem(
            ...
            name = "Correo del guardián Wild Rift",
            nameEn = "Warden's Mail Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1050,
            stats = "+35 Armadura",
            statsEn = "+35 Armor",
            passive = "Cold Steel: Reduce la velocidad de ataque de los enemigos en un 15% durante 1,5 segundos cuando son golpeados por un ataque.",
        ...
        WildRiftItem(
            ...
            name = "Catalizador de Aeons Wild Rift",
            nameEn = "Catalyst of Aeons Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1100,
            stats = "+200 de salud máxima • +300 de maná máximo",
            statsEn = "+200 Max Health • +300 Max Mana",
            passive = "Eternidad: Restaura maná equivalente al 15% del daño recibido de los campeones. Regen Health equivale al 20% del maná gastado. Limitado a 15 de salud por lanzamiento.",
        ...
        WildRiftItem(
            ...
            name = "Chaleco de cadenas Wild Rift",
        ...
        WildRiftItem(
            ...
            name = "Chaleco de zarzas Wild Rift",
            nameEn = "Bramble Vest Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1000,
            stats = "+30 Armadura",
            statsEn = "+30 Armor",
            passive = "Espinas: cuando es golpeado por un ataque, causa 4 daños mágicos + 6% de armadura adicional al atacante e inflige 40% de heridas graves durante 3 segundos si es un campeón. Las heridas graves reducen la efectividad de los efectos de curación y regeneración.",
        ...
        WildRiftItem(
            ...
            name = "Sudario Glacial Wild Rift",
            nameEn = "Glacial Shroud Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1000,
            stats = "+20 armadura • +150 maná máximo • +10 celeridad de habilidad",
        ...
        WildRiftItem(
            ...
            name = "Rift salvaje de placa lunar alada",
            nameEn = "Winged Moonplate Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 900,
            stats = "+150 de salud máxima",
        ...
        WildRiftItem(
            ...
            name = "Escalas crecientes Wild Rift",
            nameEn = "Surging Scales Wild Rift",
            category = "Artículos de Nivel Medio",
            goldCost = 1300,
            stats = "+40 Armadura",
            statsEn = "+40 Armor",
            passive = "Oleada: obtienes un 20 % de resistencia lenta mientras estás en combate con un campeón enemigo.",
        ...
        WildRiftItem(
            id = "verdant_barrier",
            name = "Barrera verdeante",
            nameEn = "Verdant Barrier",
            category = "Artículos de Nivel Medio",
            goldCost = 1600,
            stats = "+40 Poder de Habilidad • +25 Resistencia Mágica",
            statsEn = "+40 Ability Power • +25 Magic Resistance",
            passive = "Anular: Otorga un escudo contra hechizos que bloquea la siguiente habilidad enemiga. (50s de tiempo de reutilización)",
        ...
        WildRiftItem(
            ...
            category = "Artículos Básicos",
            goldCost = 500,
            stats = "+50 salud máxima",
            statsEn = "+50 Max Health",
            passive = "Quemar: inflige de 5 a 10 daños mágicos por segundo a los enemigos cercanos.",
        ...
        WildRiftItem(
            ...
            name = "Lágrima de la Diosa Wild Rift",
            nameEn = "Tear of the Goddess Wild Rift",
            category = "Artículos Básicos",
            goldCost = 500,
            stats = "+200 maná máximo • +5 celeridad de habilidad",
        ...
        WildRiftItem(
            ...
            stats = "Búsqueda:",
            statsEn = "Quest:",
            passive = "Versátil: obtiene 10 de daño de ataque o 20 de poder de habilidad (adaptable).\nTributo: Gana 1 orbe(s) de energía circundante cada 30 segundos (máximo 3 orbes). Mientras estés cerca de un aliado, las siguientes acciones activarán Tributo, consumiendo 1 orbe(s) de energía para otorgarte 65 de oro y restaurar tu salud 20-80:1. Usar habilidades o ataques para dañar estructuras o campeones enemigos.2. Atacar a súbditos por debajo del 65% de salud. Esto también los ejecuta, y el oro generado por las muertes de súbditos se entrega al aliado más cercano a ti. 3. Un minion cercano muere mientras tienes 3 orbes. Al activar el Tributo, el aliado más cercano a ti gana acumulaciones de Tributo. Centinela: inflige 1 daño más a los centinelas visuales revelados por la lente de barrido, el centinela de control y la floración del Arúspice. Restricción: no ganas oro generado por la muerte de súbditos, pero ganas oro equivalente al 50% de la recompensa. El oro generado por las muertes de tus súbditos se entregará al aliado más cercano a ti. El oro obtenido al matar monstruos se reduce en un 50%. Misión: Gana 750 de oro con este objeto para transformarlo en Black Mist Scythe y unirte a ti y al aliado con la mayor cantidad de tributos como socios perfectos.",
