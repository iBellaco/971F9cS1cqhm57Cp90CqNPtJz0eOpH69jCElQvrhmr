...
object WildRiftItemsData {
    val list: List<WildRiftItem> = buildList {
        ...
        add(WildRiftItem(
            ...
            namePt = "Cleaver Negra",
            category = "Daño Físico",
            goldCost = 3000,
            stats = "+350 Vida Máxima • +40 Daño de Ataque • +20 Aceleración de Habilidad",
            statsEn = "+350 Max Health • +40 Attack Damage • +20 Ability Haste",
            statsPt = "+350 Vida Máxima • +40 Dano de Ataque • +20 Aceleração de Habilidade",
            passive = "Trinchar: Infligir daño físico a un campeón reduce su armadura un 4% durante 6 s (se acumula hasta 6 veces, 24% de reducción total).\nRabia: Infligir daño físico otorga 20 de Velocidad de Movimiento adicional durante 2 s.",
            passiveEn = "Sunder: Dealing physical damage reduces target Armor by 4% for 6s (up to 6 times, 24% total reduction).\nRage: Physical damage grants 20 Movement Speed for 2s.",
            passivePt = "Talhar: Causar dano físico reduz a Armadura em 4% por 6s (acumula até 6 vezes, 24% de redução total).\nFúria: Concede 20 de Velocidade de Movimento por 2s.",
            coachTip = "El objeto por excelencia para luchadores y colosos frente a composiciones resistentes: reduce masivamente la armadura enemiga.",
            coachTipEn = "Premier bruiser item: shreds enemy armor and grants combat mobility.",
            coachTipPt = "Item primordial para lutadores: tritura a armadura inimiga e concede mobilidade.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/16.16.1/img/item/3071.png"
        ))
        add(WildRiftItem(
            id = "steraks_gage_defense",
            ...
            passive = "Garras Pesadas: Otorga un 50% de daño de ataque básico adicional como Daño de Ataque adicional.\nLínea de Vida: Al recibir daño que reduzca tu vida por debajo del 35%, obtienes un escudo equivalente al 75% de tu Vida adicional que decae a lo largo de 4 s, además de un 30% de Tenacidad.",
            passiveEn = "Heavy Hands: Gain 50% base AD as bonus AD.\nLifeline: Taking damage that reduces health below 35% grants a decaying shield equal to 75% bonus health and 30% Tenacity.",
            passivePt = "Mãos Pesadas: Concede 50% do Dano de Ataque base como DA adicional.\nLinha de Vida: Concede escudo ao cair abaixo de 35% de vida e 30% de Tenacidade.",
            coachTip = "Salva a los luchadores y colosos de ser eliminados de un combo explosivo y potencia el daño sostenido.",
            coachTipEn = "Crucial anti-burst shield for bruisers and juggernauts.",
            coachTipPt = "Escudo anti-burst vital para lutadores e colossos.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/16.16.1/img/item/3053.png"
        ))
        add(WildRiftItem(
            id = "spirit_visage_defense",
            name = "Apariencia Espiritual",
            nameEn = "Spirit Visage",
            namePt = "Semblante Espiritual",
            category = "Defensa",
            goldCost = 2800,
            stats = "+350 Vida Máxima • +50 Resistencia Mágica • +10 Aceleración de Habilidad • +100% Regeneración de Vida",
            statsEn = "+350 Max Health • +50 Magic Resistance • +10 Ability Haste • +100% Health Regen",
            statsPt = "+350 Vida Máxima • +50 Resistência Mágica • +10 Aceleração de Habilidade • +100% Regen de Vida",
            passive = "Vitalidad Ilimitada: Aumenta todas las curaciones y la potencia de los escudos que recibes en un 30%.",
            passiveEn = "Boundless Vitality: Increases all healing and shield effects received by 30%.",
            passivePt = "Vitalidade Ilimitada: Aumenta todas as curas e escudos recebidos em 30%.",
            coachTip = "Indispensable si tu campeón tiene autosustento o juegas con soportes curadores frente a daño mágico rival.",
            coachTipEn = "Essential against magic damage for self-healing champions or when paired with healing enchanters.",
            coachTipPt = "Essencial contra dano mágico para campeões com autocura ou com suportes curadores.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/16.16.1/img/item/3065.png"
        ))
        add(WildRiftItem(
            ...
            category = "Daño Físico",
            goldCost = 3000,
            stats = "+250 Vida Máxima • +50 Daño de Ataque • +15 Penetración de Armadura",
            statsEn = "+250 Max Health • +50 Attack Damage • +15 Armor Penetration",
            statsPt = "+250 Vida Máxima • +50 Dano de Ataque • +15 Penetração de Armadura",
            passive = "Velo: Otorga un escudo de hechizos que bloquea la siguiente habilidad enemiga (35 s de enfriamiento fuera de combate).",
            passiveEn = "Annul: Grants a spell shield that blocks the next enemy ability (35s out-of-combat cooldown).",
            passivePt = "Anular: Concede um escudo de feitiço que bloqueia a próxima habilidade inimiga.",
            coachTip = "Permite a los asesinos y tiradores de letalidad iniciar ataques evitando el primer control de masas enemigo.",
            coachTipEn = "Protects assassins and letality carries from initial crowd control during engagements.",
            coachTipPt = "Protege assassinos contra o primeiro controle de grupo inimigo ao engajar.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/16.16.1/img/item/3814.png"
        ))
        add(WildRiftItem(
            id = "rapid_firecannon_physical",
            name = "Cañón de Fuego Rápido",
            nameEn = "Rapid Firecannon",
            namePt = "Canhão Fumegante",
            category = "Daño Físico",
            goldCost = 2900,
            stats = "+25% Probabilidad de Crítico • +35% Velocidad de Ataque • +5% Velocidad de Movimiento",
            statsEn = "+25% Critical Rate • +35% Attack Speed • +5% Movement Speed",
            statsPt = "+25% Chance de Crítico • +35% Velocidade de Ataque • +5% Velocidade de Movimento",
            passive = "Energizado: Moverse y atacar genera un ataque energizado.\nFuego Rápido: Los ataques energizados aumentan el alcance de ataque un 35% (hasta +150 de alcance) e infligen 50-120 de daño mágico adicional.",
            passiveEn = "Energized attacks gain 35% bonus range (up to +150) and deal 50-120 bonus magic damage.",
            passivePt = "Ataques energizados ganham 35% de alcance adicional e causam dano mágico extra.",
            coachTip = "Ideal para asediar torretas y pokear desde una distancia segura con tiradores como Caitlyn, Jinx o Tristana.",
            coachTipEn = "Perfect for sieging and safe poke range on marksmen like Caitlyn and Jinx.",
            coachTipPt = "Perfeito para cerco de torres e poke a longa distância.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/16.16.1/img/item/3094.png"
        ))
        add(WildRiftItem(
            id = "serpents_fang_physical",
            name = "Colmillo de Serpiente",
            nameEn = "Serpent's Fang",
            namePt = "Presa da Serpente",
            category = "Daño Físico",
            goldCost = 2800,
            stats = "+55 Daño de Ataque • +15 Penetración de Armadura • +10 Aceleración de Habilidad",
            statsEn = "+55 Attack Damage • +15 Armor Penetration • +10 Ability Haste",
            statsPt = "+55 Dano de Ataque • +15 Penetração de Armadura • +10 Aceleração de Habilidade",
            passive = "Segador de Escudos: Infligir daño a un campeón enemigo reduce los escudos que reciba en un 50% (35% para campeones a distancia) durante 3 s.",
            passiveEn = "Shield Reaver: Dealing damage reduces incoming enemy shields by 50% (35% ranged) for 3s.",
            passivePt = "Quebra-Escudo: Reduz escudos inimigos em 50% (35% à distância).",
            coachTip = "Compra situacional obligatoria cuando el equipo rival tenga múltiples campeones de escudos masivos (Sett, Shen, Karma, Lulu, Sterak).",
            coachTipEn = "Crucial counter against heavy shield compositions (Sett, Karma, Lulu, Shen).",
            coachTipPt = "Item situacional essencial contra composições com muitos escudos.",
        ...
        add(WildRiftItem(
            ...
            category = "Daño Físico",
            goldCost = 2700,
            stats = "+25 Daño de Ataque • +1000 Maná Máximo • +15 Aceleración de Habilidad",
            statsEn = "+25 Attack Damage • +1000 Max Mana • +15 Ability Haste",
            statsPt = "+25 Dano de Ataque • +1000 Mana Máximo • +15 Aceleração de Habilidade",
            passive = "Asombro: Otorga Daño de Ataque equivalente al 1.5% del Maná Máximo.\nCarga de Maná: Al alcanzar 700 de Maná adicional, se transforma en Muramana.",
            passiveEn = "Awe: Grants bonus AD equal to 1.5% Max Mana. Transforms into Muramana upon reaching 700 bonus mana.",
            passivePt = "Asombro: Concede Dano de Ataque baseado na Mana Máxima. Transforma-se em Muramana.",
            coachTip = "Pilar esencial para tiradores y hechiceros AD de alto consumo de maná como Ezreal, Jayce, Corki y Varus.",
            coachTipEn = "Core scaling item for mana-hungry AD casters like Ezreal, Jayce, and Varus.",
            coachTipPt = "Item essencial para atiradores dependentes de mana.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/16.16.1/img/item/3004.png"
        ))
        add(WildRiftItem(
            id = "archangels_staff_magic",
            name = "Báculo del Arcángel",
            nameEn = "Archangel's Staff",
            namePt = "Cajado do Arcanjo",
            category = "Mágico",
            goldCost = 2950,
            stats = "+35 Poder de Habilidad • +1200 Maná Máximo • +20 Aceleración de Habilidad",
            statsEn = "+35 Ability Power • +1200 Max Mana • +20 Ability Haste",
            statsPt = "+35 Poder de Habilidade • +1200 Mana Máximo • +20 Aceleração de Habilidade",
            passive = "Asombro: Otorga Poder de Habilidad equivalente al 3% del Maná adicional.\nCarga de Maná: Al alcanzar 700 de Maná adicional, se transforma en Abrazo del Serafín.",
            passiveEn = "Awe: Grants bonus AP equal to 3% bonus Mana. Transforms into Seraph's Embrace at 700 bonus mana.",
            passivePt = "Asombro: Concede PH baseado na Mana. Transforma-se em Abraço de Seraph.",
            coachTip = "El objeto de escalado definitivo para magos de spam de habilidades (Kassadin, Ryze, Orianna, Ziggs).",
            coachTipEn = "Primary scaling item for high-mana AP mages.",
            coachTipPt = "Item primordial de escalonamento para magos.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/16.16.1/img/item/3003.png"
        ))
        ...
        "sterak" to "calibrador de sterak",
        "canon de fuego rapido" to "cañón de fuego rápido",
        "cañon de fuego rapido" to "cañón de fuego rápido",
        "cañón de fuego rápido" to "cañón de fuego rápido",
        "rapid firecannon" to "cañón de fuego rápido",
        "rapidfire cannon" to "cañón de fuego rápido",
        "malla de espinas" to "cota de espinas",
        "thornmail" to "cota de espinas",
        "creagrietas" to "creador de grietas",
        "crea grietas" to "creador de grietas",
        "riftmaker" to "creador de grietas",
        "medallon de los solari" to "relicario de los solari de hierro",
        "medallón de los solari" to "relicario de los solari de hierro",
        "locket enchant" to "relicario de los solari de hierro",
        "locket" to "relicario de los solari de hierro",
        ...
        "botas blindadas" to "punteras revestidas",
        "botas de placas de acero" to "punteras revestidas",
        "plated steelcaps" to "punteras revestidas",
        "tabi ninja" to "punteras revestidas",
        "tabi" to "punteras revestidas",
        "botas de mercurio" to "pasos de mercurio",
        "mercury's treads" to "pasos de mercurio",
        "mercury treads" to "pasos de mercurio",
        "botas de hechicero" to "botas de maná",
        "botas de mana" to "botas de maná",
        "sorcerer's shoes" to "botas de maná",
        "botas jonias" to "botas jonias de la lucidez",
        "botas de lucidez" to "botas jonias de la lucidez",
        "la sanguinaria" to "sanguinaria",
        "bloodthirster" to "sanguinaria",
        "filo de la noche" to "filo de la noche",
        "edge of night" to "filo de la noche",
        "promesa del caballero" to "promesa de caballero",
        "knight's vow" to "promesa de caballero",
        "coloso de zeke" to "convergencia de zeke",
        "zeke's convergence" to "convergencia de zeke",
        "colmillo de serpiente" to "colmillo de serpiente",
        "serpent's fang" to "colmillo de serpiente",
        "serpents fang" to "colmillo de serpiente"
    )
