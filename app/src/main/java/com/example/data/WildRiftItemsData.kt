...
object WildRiftItemsData {
    val list: List<WildRiftItem> = listOf(
        ...
        WildRiftItem(
            ...
            passive = "Éstasis (activa): El campeón se vuelve invulnerable e inalcanzable durante 2,5 s, pero tampoco podrá moverse, atacar, lanzar hechizos ni usar objetos. (120 s de enfriamiento).",
        ...
        WildRiftItem(
            ...
            category = "Objetos de Hechizo Activos",
            goldCost = 3300,
            stats = "+40 Daño de ataque • +20 % Velocidad de ataque • +450 Vida máxima • +20 Celeridad de habilidad",
            statsEn = "+40 Attack Damage • +20% Attack Speed • +450 Max Health • +20 Ability Haste",
            passive = "Corte frenético (activa): Te deslizas una corta distancia hacia adelante, infligiendo 175% de DA físico a los enemigos cercanos y ralentizándolos un 60% que decae durante 2 s. (15 s de enfriamiento).\nFrenesí (pasiva): Infligir daño físico otorga 20 de velocidad de movimiento durante 2 s.",
            passiveEn = "Halting Slash (Active): Dash a short distance forward, dealing 175% AD physical damage to nearby enemies and slowing them by 60% decaying over 2s. (15s Cooldown).\nHeroic (Passive): Dealing physical damage grants 20 Move Speed for 2s.",
            coachTip = "Indispensable para colosos y luchadores terrestres como Darius, Sett o Garen para cerrar la brecha con campeones de rango y aplicar ralentizaciones masivas.",
            coachTipEn = "Crucial for juggernauts and bruisers to close gaps against ranged champions and guarantee slow locks.",
            iconUrl = "https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/items/6631.png"
        ),
        WildRiftItem(
            id = "goredrinker",
            ...
            category = "Objetos de Hechizo Activos",
            goldCost = 3300,
            stats = "+55 Daño de ataque • +400 Vida máxima • +20 Celeridad de habilidad • +150 % Regeneración de vida",
            statsEn = "+55 Attack Damage • +400 Max Health • +20 Ability Haste • +150% Base Health Regen",
            passive = "Cuchillada sedienta (activa): Inflige 100% de DA físico a los enemigos circundantes. Cura un 25% de DA + 10% de vida faltante por cada campeón impactado. (15 s de enfriamiento).\nIcor (pasiva): Otorga hasta un 15% de DA adicional según tu vida faltante.",
            passiveEn = "Thirsting Slash (Active): Deal 100% AD physical damage to surrounding enemies. Heal for 25% AD + 10% missing Health per champion hit. (15s Cooldown).\nSpite (Passive): Gain up to 15% bonus AD based on missing Health.",
            coachTip = "El objeto por excelencia para teamfights prolongadas en luchadores y duelistas (Aatrox, Riven, Renekton, Olaf), permitiendo sobrevivir y dar la vuelta a combates 1v3 o 1v5.",
            coachTipEn = "The ultimate teamfight survival active for bruisers and duelists, turning fights around at low HP.",
            iconUrl = "https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/items/6630.png"
        ),
        WildRiftItem(
            id = "galeforce",
            ...
            category = "Objetos de Hechizo Activos",
            goldCost = 3400,
            stats = "+55 Daño de ataque • +20 % Velocidad de ataque • +25 % Probabilidad de impacto crítico",
            statsEn = "+55 Attack Damage • +20% Attack Speed • +25% Critical Strike Chance",
            passive = "Disparo nuboso (activa): Te deslizas en la dirección objetivo y disparas 3 proyectiles de misiles al enemigo con menos vida cercano, infligiendo 180-315 de daño mágico incrementado contra objetivos con poca vida. (90 s de enfriamiento).",
            passiveEn = "Cloudburst (Active): Dash in target direction, firing 3 missile homing projectiles at lowest-health enemy, dealing 180-315 magic damage increased against low HP targets. (90s Cooldown).",
            coachTip = "Otorga un dash salvavidas y burst de ejecución a tiradores inmóviles como Jhin, Jinx o Caitlyn, permitiendo esquivar habilidades clave o asegurar asesinatos a la fuga.",
            coachTipEn = "Provides a crucial dash and execution missile burst for immobile ADCs to dodge key skillshots and execute fleeing enemies.",
            iconUrl = "https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/items/6671.png"
        ),
        WildRiftItem(
            ...
            category = "Objetos de Hechizo Activos",
            goldCost = 3000,
            stats = "+40 Daño de ataque • +25 % Probabilidad de impacto crítico • +35 Resistencia mágica",
            statsEn = "+40 Attack Damage • +25% Critical Strike Chance • +35 Magic Resistance",
            passive = "Mercurio (activa): Elimina todas las desventajas de control de masas y otorga 50% de velocidad de movimiento adicional durante 1,5 s. (60 s de enfriamiento).",
            passiveEn = "Quicksilver (Active): Removes all crowd control debuffs and grants 50% bonus Move Speed for 1.5s. (60s Cooldown).",
            coachTip = "Esencial para tiradores AD y duelistas de crítico cuando el equipo enemigo tiene aturdimientos fijos o cadenas de CC que te impiden golpear.",
            coachTipEn = "Essential for AD carries and critical strike duelists against heavy lockdown compositions.",
            iconUrl = "https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/items/3139.png"
        ),
        WildRiftItem(
            id = "hextech_roketbelt",
            name = "Cinturón de cohetes hextech",
