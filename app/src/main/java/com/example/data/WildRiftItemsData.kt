...
object WildRiftItemsData {
    val list: List<WildRiftItem> = listOf(
        ...
        WildRiftItem(
            ...
            passive = "Luna en Crecimiento: Golpear a un campeón enemigo con 2 ataques o habilidades separados en 1.8 s inflige daño físico adicional equivalente al 7% de la vida máxima del objetivo (3.5% para campeones a distancia), y otorga un escudo de 140 + 35% de daño de ataque adicional (70 + 18% para campeones a distancia) durante 2 s (6 s de enfriamiento).",
