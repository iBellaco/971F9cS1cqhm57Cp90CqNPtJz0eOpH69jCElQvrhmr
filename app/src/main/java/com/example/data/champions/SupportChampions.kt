...
object SupportChampions {
    val list: List<Champion> = listOf(
        ...
        Champion(
            ...
            recommendedSpells = listOf("Prender", "Destello"),
            spellsIcons = listOf(),
            coreItems = listOf("Escudo de reliquia", "Botas blindadas", "WARMONG", "corazón de acero", "Botas blindadas", "corazón de acero"),
            coreItemsIcons = listOf(),
            situationalItems = listOf("Rookern kaénico", "malla de espinas"),
            itemSwaps = listOf(),
            situationalItemsIcons = listOf(),
            skillOrder = "Habilidad 1 > Habilidad 2 > Habilidad 3 (Priorizar Definitiva)",
            isRanged = true,
