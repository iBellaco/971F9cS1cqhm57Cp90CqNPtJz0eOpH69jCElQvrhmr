...
replacement = '''                            // 4. Sinergias (Aliadas y Enemigas)
...
content = content.replace('''                            // 4. DETALLE RÁPIDO DE CAMPEÓN SI ESTÁ SELECCIONADO
                            if (selectedChampionDetail != null) {''', replacement)
