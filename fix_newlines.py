...
def escape_newlines_in_quotes(text):
    # Find all content within double quotes and replace actual newlines with \n
    # A bit risky to do globally, but we can do it for the passive and passiveEn lines specifically.
    pass

# Alternatively, I will just rewrite those items correctly.
rs = """id = "relic_shield",
